  ...
  const dets = [
    {
      ...
      text: "+918960629039",
      link: "tel:+918960629039",
    },
    {
      id: "2",
      icon: <i className="fa-solid fa-envelope"></i>,
      text: "madhurpathak000@gmail.com",
      link: "madhurpathak000@gmail.com",
    },
    {
      id: "3",
      icon: <i className="fa-solid fa-location-dot"></i>,
      text: "Jhansi UP, India ",
    },
  ];
  return (
    <section id="Contact" className="lg:px-24 pt-12 pb-6">
      ...
      <div className="flex flex-col pb-8 px-8 lg:flex-row bg-[#131313] lg:p-20 rounded-lg">
        ...
        >
          <form
            action="https://formsubmit.co/madhurpathak000@gmail.com"
            method="POST"
            target="_blank"
